                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Emissions</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= site_url() ?>dashboard"><i
                                        class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="<?= site_url() ?>list-podcasts">Posts</a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?= form_open('podcast-edit/' . $podcast->podcastId) ?>
                        <?= csrf_field() ?>
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="category_id" class="form-control">
                                        <option value="<?= $podcast->category_id ?>" <?= set_select('category_id', $podcast->category_id); ?>><?= ucfirst($podcast->name) ?></option>
